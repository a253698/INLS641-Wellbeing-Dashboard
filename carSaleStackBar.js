...
// Parse the Data
d3.csv(
  "https://raw.githubusercontent.com/chintseng/my_csv_file/master/enrgy_data/Car%20sales%20by%20size%20and%20powertrain%2C%202010-2020.csv"
).then(function (data) {
...
function update(data) {
  ...
  // map to data
  const u = svg_pie.selectAll("path").data(data_ready);
